  ...
  namespace python
  {
    ...
    void exposeIntegrators()
    {
      ...
      bp::class_<IntegratorDataTpl<Scalar>, bp::bases<DynamicsDataTpl<Scalar>>>(
        ...
        .def_readwrite("continuous_data", &IntegratorDataTpl<Scalar>::continuous_data);
      ...
      bp::class_<ExplicitIntegratorDataTpl<Scalar>, bp::bases<ExplicitDynamicsDataTpl<Scalar>>>(
        "ExplicitIntegratorData", "Data struct for explicit time integrators.", bp::no_init
      )
        .def_readwrite("continuous_data", &ExplicitIntegratorDataTpl<Scalar>::continuous_data);
      ...
      bp::class_<IntegratorEulerTpl<Scalar>, bp::bases<ExplicitIntegratorAbstract>>(
        ...
        bp::init<shared_ptr<ODEType>, Scalar>(bp::args("self", "ode", "timestep"))
      )
        .def_readwrite("timestep", &IntegratorEulerTpl<Scalar>::timestep_, "Time step.");

      bp::class_<IntegratorRK2Tpl<Scalar>, bp::bases<ExplicitIntegratorAbstract>>(
        "IntegratorRK2",
        bp::init<shared_ptr<ODEType>, Scalar>(bp::args("self", "ode", "timestep"))
      )
        .def_readwrite("timestep", &IntegratorRK2Tpl<Scalar>::timestep_, "Time step.");
    }
